    ...
    const features = [
        {
            ...
            title: t("features.easyCollections.title"),
            description: t("features.easyCollections.description"),
            color: "#2466eb",
        },
        {
            icon: (
            ...
            title: t("features.instantDisbursements.title"),
            description: t("features.instantDisbursements.description"),
            color: "#ef2d10",
        },
        {
            icon: (
            ...
            description: t("features.bankGradeSecurity.description"),
            color: "#10b981",
        },
    ];
